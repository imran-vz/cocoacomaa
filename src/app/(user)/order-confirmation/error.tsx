...
import { AlertCircle, ArrowLeft, RotateCcw, ShoppingCart } from "lucide-react";
				...
				<Card>
					<CardContent className="py-8 sm:py-10 text-center">
						...
						<p className="text-muted-foreground text-sm sm:text-base mb-2 max-w-sm mx-auto leading-relaxed">
							We had trouble loading your order confirmation. Don't worry — if
							your payment was successful, your order is confirmed. You can
