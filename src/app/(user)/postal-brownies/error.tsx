...
export default function PostalBrowniesError({
	error,
	reset,
}: {
	...
	useEffect(() => {
		console.error("Postal brownies page error:", error);
	}, [error]);
